 ...
 * (filesystem watching and generated agent artifacts) need
...
export async function releaseHostDataRootOwnership(): Promise<void> {
  await releaseDataRootOwnership();
}
