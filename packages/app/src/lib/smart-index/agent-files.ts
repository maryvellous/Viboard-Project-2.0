...
function generatedHeader(): string {
  return `<!-- Auto-generated by Diaspro Viboard on ${new Date().toISOString()}. Do not edit by hand. Marker-block content comes from Settings → Agents; everything else is overwritten on regen. -->`;
}
...
function buildTopLevelAgentFile(workspaces: Workspace[], deskPath: string): string {
  ...
  lines.push("");
  lines.push("# Diaspro Viboard: AI Agent Guide");
  lines.push("");
